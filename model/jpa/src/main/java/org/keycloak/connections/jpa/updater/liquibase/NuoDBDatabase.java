 ...
 */
public class NuoDBDatabase extends MySQLDatabase {
    private static final String PRODUCT_NAME = "NuoDB";
    ...
    protected String getDefaultDatabaseProductName() {
        return NuoDBDatabase.PRODUCT_NAME;
    }

    @Override
    public String getDefaultDriver(String url) {
        if (url.startsWith("jdbc:nuodb")) {
            return "com.nuodb.jdbc.DataSource";
        }
        return null;
    }
